...
// Admin Routes
router.post("/items", authenticate, authorize("ADMIN", "MANAGER"), validate(menuItemSchema), createMenuItem);
router.put("/items/:id", authenticate, authorize("ADMIN", "MANAGER"), validate(menuItemSchema), updateMenuItem);
